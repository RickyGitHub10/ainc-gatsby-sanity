        ...
        <Container className={styles.footerBackground}>
          <Row>
            ...
            <Col xs md={4} aria-label="main-navigation" role="navigation">
              ...
              <Row className={styles.firstColRow}>
                {/*Newsletter Form*/}
                <BrandButton onClick={handleShow} className="my-3">
                  Newsletter Sign Up
                </BrandButton>
                <Modal
                  show={show}
                ...
                >
                  ...
                  >
                    ...
                    <Modal.Body>
                      <label for="First Name" style={{ marginLeft: "4px" }}>
                        First Name
                      </label>
                      <input
                      ...
                      />
                      <br />
                      <label for="Last Name" style={{ marginLeft: "4px" }}>
                        Last Name
                      </label>
                      <input
                        class="form-control"
                      ...
                      <br />
                      {/*<!--Email-->*/}
                      <label for="Email Address" style={{ marginLeft: "4px" }}>
                        Email Address
                      </label>
                      <input
                        class="form-control"
                      ...
                      <br />
                      {/*<!-- Phone -->*/}
                      <label for="Company" style={{ marginLeft: "4px" }}>
                        Phone
                      </label>
                      <input
                        class="form-control"
            ...
            <Col
              ...
              sm={6}
              md={2}
              aria-label="quicklinks-navigation"
              role="navigation"
            >
            ...
            <Col
              ...
              sm={6}
              md={4}
              aria-label="sponsors-navigation"
              role="navigation"
            >
